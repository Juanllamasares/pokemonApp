...
import { deleteCapturedPokemon } from "../../store/pokemonsWithSlice/pokemonSlice";

export const PokemonCaptured = ({ name }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <button className='btn btn-outline-danger mb-1' onClick={()=>dispatch(deleteCapturedPokemon(data?.name))}>Abandonar</button>
        <Card.Body
